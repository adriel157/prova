...
from .forms import NoticiaForm, NoticiaFilterForm, CategoriaForm,UserBlogCreationForm
...
def list_categorias(request):
    formularioFiltro = CategoriaForm(request.GET or None)
    ...
    paginator = Paginator(categorias, 3)  # Mostra 10 categorias por página
...
def cadastrar_categoria(request):
    ...
    return render(request, 'gerencia/cadastrar_categoria.html', contexto)
